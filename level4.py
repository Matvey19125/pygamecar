...
def park():
    ...
    nps_four_collider = nps_four_scaled.get_rect(topleft=(640, 570))
    ...
    nps_eith_collider = nps_eith_scaled.get_rect(topleft=(560, 50))
    ...
    nps_nine_collider = nps_nine_scaled.get_rect(topleft=(300, 650))
