...
def park():
    ...
    money_collider = pygame.Rect(135, 500, 60, 60)
    ...
    nps_four_collider = nps_four_scaled.get_rect(topleft=(30, 570))
    ...
    nps_nine_collider = nps_nine_scaled.get_rect(topleft=(150, 350))
