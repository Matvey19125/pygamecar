...
def park():
    ...
    nps_three_collider = nps_three_scaled.get_rect(topleft=(500, 570))
    ...
    nps_six_collider = nps_six_scaled.get_rect(topleft=(600, 300))
